...
function loadRecentActivity() {
  ...
  // Create activity log from recent tickets
...
function showAdminSection(sectionName) {
  ...
  document.querySelector(`.dashboard-nav a[href="#${sectionName}"]`).classList.add("active")
...
// Additional CSS for admin-specific styles
const adminStyles = `
    .analytics-card {
